...
class UserHandler extends Database {
  ...
  Future<State> addUser() => addDocument({"Name": this.user.name, "Email": this.user.email, "Image": this.user.image});
  Future<State> upDateUser(Map<String, Object> data) => upDateDocument(this.user.email, data);
